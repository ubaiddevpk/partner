...
//   })
//   .eq("id", user.id);
//   console.log("Submitting business name:", llcName);
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    // 🔹 Upsert: safe for new users (signup) and existing users
    const { data: profileData, error: profileError } = await supabase
      .from("profiles")
      .upsert({
        id: user.id,
        full_name: user.user_metadata?.full_name || "", // from signup metadata
        business_name: llcName.trim(), // from onboarding form
      })
      .select()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 left-20 w-96 h-96 bg-secondary-200 rounded-full opacity-20 blur-3xl animate-pulse-slow"
      ...
      <div className="relative min-h-[calc(100vh-120px)] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="relative">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-neutral-600 text-lg">
                    Tell us about your company to get started with AI-powered
                    project management.
                  </p>
                </div>
          ...
          {/* Right Side - Benefits */}
          <div
            className="order-1 lg:order-2 space-y-8 animate-fade-in-up"
          ...
          >
            ...
            <div>
              ...
              <p className="text-xl text-neutral-600 leading-relaxed">
                Join thousands of contractors who are closing more deals and
                saving time with AI-powered tools.
              </p>
            </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-neutral-600">
                    Contractors trust us
                  </div>
                </div>
              </div>
              <p className="text-sm text-neutral-700 italic leading-relaxed">
                "Partner transformed how we handle estimates. What used to take
                hours now takes minutes, and our proposals look more
